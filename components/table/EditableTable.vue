    ...
    <v-table class="mt-5">
        <thead>
            <tr>
                ...
                <th class="text-subtitle-1 font-weight-semibold text-no-wrap">UserInfo</th>
                <th class="text-subtitle-1 font-weight-semibold text-no-wrap">Phone</th>
                <th class="text-subtitle-1 font-weight-semibold text-no-wrap">Joining Date</th>
                <th class="text-subtitle-1 font-weight-semibold text-no-wrap">Role</th>
        ...
        <tbody>
            <tr v-for="item in filteredList" :key="item.id">
                ...
                <td class="text-subtitle-1 text-no-wrap">{{ item.jdate }}</td>
                <td>
