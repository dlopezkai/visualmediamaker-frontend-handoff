                    ...
                    <tbody>
                            ...
                            <td>
                                <div class="d-flex align-center">
                                    <v-avatar size="48" rounded="md">
                                        <img src="/images/products/s6.jpg" alt="icon" width="50"
                                    /></v-avatar>
                                    <div class="mx-3">
                        ...
                        <tr class="month-item">
                            <td>
                                <div class="d-flex align-center">
                                    <v-avatar size="48" rounded="md">
                                        <img src="/images/products/s9.jpg" alt="icon" width="50"
                                    /></v-avatar>
                                    <div class="mx-3">
                        ...
                        <tr class="month-item">
                            <td>
                                <div class="d-flex align-center">
                                    <v-avatar size="48" rounded="md">
                                        <img src="/images/products/s7.jpg" alt="icon" width="50"
                                    /></v-avatar>
                                    <div class="mx-3">
                        ...
                        <tr class="month-item">
                            <td>
                                <div class="d-flex align-center">
                                    <v-avatar size="48" rounded="md">
                                        <img src="/images/products/s4.jpg" alt="icon" width="50"
                                    /></v-avatar>
                                    <div class="mx-3">
